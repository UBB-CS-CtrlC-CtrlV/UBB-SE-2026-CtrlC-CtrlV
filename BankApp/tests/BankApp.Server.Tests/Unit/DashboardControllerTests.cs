...
{
    private readonly Mock<IDashboardService> dashService = new Mock<IDashboardService>();
    ...
    public void GetDashboard_WhenSuccess_ReturnsOkWithData()
    {
        ...
        this.dashService.Setup(s => s.GetDashboardData(1)).Returns(response);
